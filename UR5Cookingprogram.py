...
def pour_ingredients(robo):
    ...
    robo.teach_mode.play("trajectory/pourcup1203201.json")
    ...
    robo.teach_mode.play("trajectory/pourcuptt9320.json")
...
def pour_batter(robo, cookingtime1, startingtime):
    ...
    robo.teach_mode.play_fast("trajectory/scoop93201.json", speedup = 3)
    
    #pour the batter into the pan
    robo.teach_mode.play("trajectory/pour93201.json")
...
def flip_pancakes(robo, cookingtime2, startingtime):
    ...
    robo.teach_mode.play("trajectory/pick163201.json")
    ...
    robo.teach_mode.play("trajectory/flip93202.json")    
...
def remove_pancakes(robo, startingtime):
    ...
    robo.teach_mode.play("trajectory/pickup93202.json") 
