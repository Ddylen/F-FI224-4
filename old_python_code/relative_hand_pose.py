# -*- coding: utf-8 -*-
"""
COde for saving human pose that saves teh hand position as relative to the wrist, in teh homes this would make displaying bad points easier
"""
...
#len(body_3D_pose[0])
ani = animation.FuncAnimation(fig, update_lines, len(BODY3DPOSE[0]), fargs = [results_list, lines, time_text],
