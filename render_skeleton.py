...
#'1.24.21.47'
BODY3DPOSE, LEFTHAND3DPOSE,RIGHTHAND3DPOSE = get_arm_3D_coordinates('1.23.17.49', confidence_threshold = 0.1)
...
def filter_out_jumps(body_3D_pose, left_hand_3D_pose,right_hand_3D_pose, threshold = 0.2):
     count= 0
