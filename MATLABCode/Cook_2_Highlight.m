%Code to highligh T_Cook_2 in the trajectory - based on modifying coed by
%Simon Huaser
...
legendtext = {'Pick up spatula', 'T\_Cook\_2', 'Return spatula'}
...
dotpoint2 = key_times_list(29+1);

plot(data(dotpoint1,1),data(dotpoint1,2),'b.','MarkerSize',25, 'DisplayName', 'T\_Cook\_2 timer start')
plot(data(dotpoint2,1),data(dotpoint2,2),'r.','MarkerSize',25, 'DisplayName', 'T\_Cook\_2 timer finish')
